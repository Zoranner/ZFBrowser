...
")]
        ...
        private readonly BrowserNavState navState = new BrowserNavState();
...
#pragma warning restore 618
        ...
        public void LoadURL(string url, bool force)
        {
            ...
            if (DeferUnready(() => LoadURL(url, force)))
            {
                return;
            }
        ...
        public void LoadDataURI(byte[] data, string mimeType)
        {
            ...
            Url = "data:" + mimeType + ";base64," + dataStr;
        }
        ...
        public void SetNewWindowHandler(NewWindowAction action, INewWindowHandler newWindowHandler)
        {
            ...
            if (DeferUnready(() => SetNewWindowHandler(action, newWindowHandler)))
            {
                return;
            }
        ...
        public void Resize(int width, int height)
        {
            ...
            if (newTexture.mipmapCount > 1)
            {
                ...
                for (var i = 1; i < newTexture.mipmapCount; i++)
                {
        ...
        protected void ProcessCallbacks()
        {
            while (thingsToDo.Count != 0)
            {
                ...
                foreach (var thingToDo in thingsToDoClone)
                {
                    thingToDo();
                }
        ...
        public void UpdateCursor()
        {
            ...
            if (DeferUnready(UpdateCursor))
            {
                return;
            }

            var cursorType = BrowserNative.zfb_getMouseCursor(browserId, out var w, out var h);
            ...
            else
            {
                ...
                BrowserNative.zfb_getMouseCustomCursor(browserId, handle.AddrOfPinnedObject(), w, h, out var hx, out var hy);
                handle.Free();
