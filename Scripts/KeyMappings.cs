...
namespace ZenFulcrum.EmbeddedBrowser
{
    ...
    {
        private static readonly Dictionary<KeyCode, int> mappings = new Dictionary<KeyCode, int>() {
        ...
        private static readonly Dictionary<int, KeyCode> reverseMappings = new Dictionary<int, KeyCode>();
        ...
        static KeyMappings()
        {
            ...
            for (var i = (int)KeyCode.A; i <= (int)KeyCode.Z; i++)
            {
                var key = (KeyCode)i;
        ...
        {
            var ukc = (int)ev.keyCode;//unity key code
            ...
            if (mappings.TryGetValue(ev.keyCode, out var ret))
            {
                return ret;
            }
        ...
        {
            if (reverseMappings.TryGetValue(windowsKeyCode, out var ret))
            {
                return ret;
            }
