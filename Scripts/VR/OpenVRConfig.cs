...
{
    internal partial class OpenVRInput
    {
        /// <summary>
        ...
        /// </summary>
        private readonly InputMode mode = InputMode.Direct;//may need to restart Unity and/or SteamVR if you switch to this mode after using the new system
