 ...
 * The namespace has been changed to avoid potential conflicts.
 * BSD License: https://github.com/ValveSoftware/openvr/blob/master/LICENSE
 */
...
namespace ZenFulcrum.VR.OpenVRBinding
{
    ...
    public class CVRSystem
    {
        ...
        {
            var result = FnTable.GetArrayTrackedDeviceProperty(unDeviceIndex, prop, propType, pBuffer, unBufferSize, ref pError);
            return result;
        }
    ...
    public class CVRCompositor
    {
        ...
        {
            var result = FnTable.IsMotionSmoothingEnabled();
            return result;
        }
    }
    ...
    public class CVROverlay
    {
        ...
        {
            var result = FnTable.SetOverlayDualAnalogTransform(ulOverlay, eWhich, ref pvCenter, fRadius);
            return result;
        }
    ...
    public class CVRRenderModels
    {
        ...
        {
            var result = FnTable.GetComponentStateForDevicePath(pchRenderModelName, pchComponentName, devicePath, ref pState, ref pComponentState);
            return result;
        }
        // This is a terrible hack to workaround the fact that VRControllerState_t and VREvent_t were
        // originally mis-compiled with the wrong packing for Linux and OSX.
    ...
    public class CVRInput
    {
        ...
        {
            var result = FnTable.GetPoseActionData(action, eOrigin, fPredictedSecondsFromNow, ref pActionData, unActionDataSize, ulRestrictToDevice);
            return result;
        }
        ...
        {
            var result = FnTable.GetSkeletalSummaryData(action, ref pSkeletalSummaryData);
            return result;
        }
