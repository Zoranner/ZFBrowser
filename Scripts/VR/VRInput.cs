...
namespace ZenFulcrum.EmbeddedBrowser.VR
{
    ...
    internal partial class OpenVRInput : VRInput
    {
        ...
        private readonly ulong pointPose, leftClick, middleClick, rightClick;
        private readonly ulong joystickScroll, touchPadScrollTouch, touchPadScrollPos;
        private readonly ulong leftHand, rightHand;
        ...
        public OpenVRInput()
        {
            if (mode == InputMode.MappedActions)
            {
                ...
                {
                    throw new ApplicationException("Failed to find hand " + res);
                }
        ...
        private bool GetDigitalInput(ulong action, XRNodeState node)
        {
            ...
            if (res != EVRInputError.None)
            {
                throw new ApplicationException("Failed to get digital input data " + node.nodeType + ": " + res);
            }
